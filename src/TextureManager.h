...
public:
	...
	void playAnimationDST(const std::string& sprite_sheet_name, Animation& animation, int x, int y, float w, float h, float speed_factor, double angle, int alpha, bool centered = false, SDL_RendererFlip flip = SDL_FLIP_NONE);
